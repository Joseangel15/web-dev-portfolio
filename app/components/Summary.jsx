  ...
  return (
    <div className="card card-border bg-base-100 w-full mb-5">
      <div className="card-body pb-0 ">
        <p>
          Hey there. I am a <strong className="text-primary">Front-End Web Developer</strong> with 5+ years of specialized
        ...
        <p>
          ...
          adventure. I'm a big fan of road trips, and I also enjoy photography
